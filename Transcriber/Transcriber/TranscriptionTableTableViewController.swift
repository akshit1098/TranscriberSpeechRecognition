//
//  TranscriptionTableTableViewController.swift
//  Transcriber
//
...
class TranscriptionTableTableViewController: UITableViewController {
    
    
    
    var dummyItems: [String] = ["g", "r", "a", "n", "t"]
    ...
    */
    ...
    func checkPermissions(){
        ...
        let recAuthorized = AVAudioApplication.shared.recordPermission == .granted

        let transAuthorized = SFSpeechRecognizer.authorizationStatus() == .authorized
        
        let authorised = recAuthorized && transAuthorized
        if !authorised{
